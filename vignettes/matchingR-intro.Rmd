...
```
```{r, echo=FALSE}
dimnames(prefM) = list(rows = c('Preference 1', 'Preference 2', 'Preference 3'), cols = c('Man 1', 'Man 2', 'Man 3'))
prefM
```
...
```
```{r, echo=FALSE}
dimnames(prefW) = list(rows = c('Preference 1', 'Preference 2', 'Preference 3'), cols = c('Woman 1', 'Woman 2', 'Woman 3'))
prefW
```
